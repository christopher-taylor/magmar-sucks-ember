...
const DANK_MEMES = ['Spewing Pedantry', 'Being Scientifically Accurate', "Lighting Crab's Cigarettes", 'Reading Bulbapedia', 'Waking Up Inside', 'Neglecting Editing', 'Skipping Pre-Production', 'Screaming into the Void', 'Weighing Porygons', 'Fragging Hikers', 'Warring Over Sticks', 'Fucking Fish', 'Misattributing Units', 'Ignoring Tier Names', 'Gitting Gud', 'Figuratively Hating Literally', 'Elongating the Laws Nipples', 'Editing Spreadsheets', 'Talking Over Each Other', 'Hating On Co-Hosts', 'Forgetting Episode Releases', 'Making the Hard Sell', 'Not Speaking Weeab', 'Folding Japanese Steel', 'Dying In Fake Japan', 'Eating Well Done Berries', 'SAVAGE', 'Taking Skullbreaker', 'Browsing Hot Topic'];
